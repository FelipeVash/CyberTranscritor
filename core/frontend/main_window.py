...
from core.frontend.widgets import FormatToolbar
from core.frontend.styles import configure_styles
from core.frontend.dialogs import show_correction_dialog
from core.frontend.tray_icon import TrayIcon
from core.frontend.settings_window import SettingsWindow
from core.utils.tooltip import ToolTip
from core.utils.helpers import handle_enter
...
class TranscriptionStudio:
    ...
    def on_closing(self):
        ...
        from core.frontend.dialogs import show_close_dialog
